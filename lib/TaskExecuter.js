...
var setupTasks = function() {
	...
	this.tasks = {
		...
		'truncate-file': ['data-request', 'file-handle-generator', 'read-meta-data', function(callback, results) {
		...
		'rename-file': ['truncate-file', 'file-name-generator', function(callback, results) {
			var req = new Renamer(results['file-name-generator'].downloadFile);
			taskInit.call(req, callback);
		}],


		'generate-meta-data': ['set-thread-headers', 'file-name-generator', 'threads-generator', 'file-handle-generator', function(callback, results) {
